    ...
    >
      <Link href={`/jobs/${job.id}`}>
        <Card className={`
          ...
          ${featured ? 'bg-gradient-to-br from-white to-blue-50 border-blue-100 shadow-md' : 'bg-white hover:bg-slate-50/50'}
        `}>
          <div className="flex flex-col h-full gap-4">
            <div className="flex justify-between items-start">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-xl bg-white border shadow-sm flex items-center justify-center p-2 overflow-hidden">
                ...
                <div>
                  <h3 className="font-display font-bold text-lg text-slate-900 group-hover:text-primary line-clamp-1">
                    {job.title}
                  </h3>
